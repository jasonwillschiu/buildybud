...
- Install: `go install github.com/jasonwillschiu/buildybud@v0.5.0`
...
- `buildybud init` seeds JS dependency defaults for `selectbox`, `datepicker`, and `timepicker` with `input` + `popover`, and `tagsinput` with `popover`.
